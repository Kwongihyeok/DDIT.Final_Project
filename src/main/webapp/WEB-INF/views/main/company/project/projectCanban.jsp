						            ...
						            <c:if test="${projectTaskVO.proTaskSttsCd eq 'TASK001'}">
						                <div class="card mb-6 mb-xl-9 draggable" id="task-${projectTaskVO.proTaskNo}" draggable="true">
            								<div class="card-body">
						                        ...
						                        <form action="/company/canbanDelete.do" method="post" id="delCanbanForm">
...
$(function(){
	...
	addProBtn.on("click", function () {
		location.href = "/company/canbanForm.do?proNo=${projectVO.proNo}";
	});
	...
	udtBtn.on("click", function () {
		delForm.attr("action", "/company/projectUpdate.do");
	...
	$(".udtCanBtn").on("click", function () {
	    ...
	    delCanbanForm.attr("action", "/company/canbanUpdate.do");
