						...
						<div id="kt_app_content_container" class="app-container container-fluid">
							...
							<div class="card card-flush" style="margin-bottom: 40px;">
									...
									<div class="card-header align-items-center py-5 gap-2 gap-md-5">
										...
										<div class="card-title">
											...
											<div class="d-flex align-items-center position-relative my-1">	
				                    			...
				                    			<form id="searchForm" style="display: contents;">
												    ...
												    <input id="myInput" name="searchWord" type="text" data-kt-ecommerce-product-filter="search" class="form-control form-control-solid w-250px ps-5" style="margin-top: 0.5em;" placeholder="양식 검색" value="${searchWord }"/>
										...
										<div style="display: flex; justify-content: center;">
											...
											<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
												<a href="/company/formInsert.do" class="btn btn-light-info">양식 등록</a>
											</div>
										</div>
									</div>
									<!--end::Card header-->
									...
									<div class="card-body pt-0 pb-0">
										<!--begin::Table-->
										<table class="table align-middle table-row-dashed fs-4 gy-5" id="kt_ecommerce_products_table">
											<thead>
												<tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0 text-center">
													...
													<th width="15%" class="h4">양식종류</th> 
													<th width="38%" class="h4">양식명</th> 
													<th width="10%" class="h4">등록인</th>
													<th width="20%" class="h4">등록일시 / 수정일시</th>  
													<th width="17%" class="h4">수정/삭제</th>  
												</tr>
											</thead>
												...
												<c:choose>
													...
													<c:otherwise>
														<c:forEach items="${formList }" var="formVO">
															<form action="/company/formDelete.do" id="formDelete" method="post">
															...
															<tr>
																...
																<td> 
																	<div>
																		<span>
																			<a href="/company/formUpdate.do?docFormNo=${formVO.docFormNo }">${formVO.docFormNm }</a>&nbsp;
																		</span>
																...
																<td>
																	<c:choose>
																		<c:when test="${formVO.coCd eq 'cp1' }">
										                            ...
										                            <c:if test="${emp.empId eq formVO.empId}">
																		...
																		<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																			<div class="menu-item px-3">
																				<a href="/company/formUpdate.do?docFormNo=${formVO.docFormNo }" class="menu-link px-3">수정하기</a>
																			</div>
																			<div class="menu-item px-3">
	...
	$('#docFormNmRow').on('click', '#docFormNmDelBtn', function() {
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				...
				$.ajax({
					type: "get",
					url: "/company/docFormKndWriteCheck.do?docFormNo=" + docFormNo,
				    success: function(res){
						if (res > 0) {
							...
							// 양식 종류 삭제하기
							$.ajax({
								url: "/company/docFormKndNmDel.do",
								type: "post",
	...
	$('#selectDelList').on('click', function() {
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				...
				$.ajax({
					url: "/company/selectWriteListDelete.do",
					type: "post",
					data: JSON.stringify(data),
					contentType : "application/json; charset=utf-8",
					success: function(res) {
...
function addDocFormKnd() {
	...
	$.ajax({
		type: "post",
		url: "/company/docFormKndNmAdd.do",
		data: JSON.stringify(data),
		contentType : "application/json; charset=utf-8",
	    success: function(res){
