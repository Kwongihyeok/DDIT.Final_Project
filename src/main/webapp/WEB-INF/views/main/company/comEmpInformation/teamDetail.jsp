...
<form action="/information/teamdelete.do" method="post" id="delForm">
    <input type="hidden" name="teamCd" value="${teamVO.teamCd }" />
</form>
<script type="text/javascript">
	...
	listBtn.on("click", function () {
		location.href = '/information/alldept.do';
	})
...
$.ajax({
    url: '/information/teamcanlendar.do', // 서버 엔드포인트
    type: 'GET',
    data: {
