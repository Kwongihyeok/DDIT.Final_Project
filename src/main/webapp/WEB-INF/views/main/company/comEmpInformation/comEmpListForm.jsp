												...
												<form id="kt_modal_add_user_form" class="form" action="/information/empinsert.do" method="post" enctype="multipart/form-data">
													<div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
														...
														<div class="fv-row mb-7">
															...
															<input type="text" name="empNm" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="사원이름을 입력해주세요" id="empNm" value="김대덕"/>
														</div>
														<div class="fv-row mb-7">
															<label class="required fw-semibold fs-6 mb-2">사번</label>
															<input type="text" name="empNo" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="사번을 입력해주세요" id="empNo" value="2024111801"/>
														</div>
														<div class="fv-row mb-7">
															<label class="required fw-semibold fs-6 mb-2">아이디</label>
															<input type="text" name="empId" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="사원 아이디를 입력해주세요" id="empId" value="dditdd003"/>
												        ...
												        <div class="fv-row mb-7">
												            ...
												            <input type="date" id="empJncmpYmd" name="empJncmpYmd" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="YYYY-MM-DD" value="2024-11-18"/>
												        </div>
														<div class="fv-row mb-7">
															<label class="required fw-semibold fs-6 mb-2">전화번호</label>
															<input type="tel" name="empTelno" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="전화번호 입력  " value="010-1353-2345" id="empTelno"/>
														</div>
													</div>
										...
										<tr>
											<td colspan="7" class="text-center pt-5">
												<div class="d-flex flex-column flex-center mt-10">
								                    ...
								                    <div class="fs-1 fw-bolder text-dark">등록된 사원이 없습니다.</div>
				              				 	</div>
											</td>
										</tr>
									</c:when>
