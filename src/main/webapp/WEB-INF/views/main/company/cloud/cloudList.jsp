				...
				<div class="modal-dialog modal-dialog-centered mw-650px">
					<div class="modal-content">
						...
						<div class="modal-body pt-5 pb-5 px-lg-17">
						 	<form id="newFldrInsertForm" action="/company/cloudNewFldrInsert.do" method="post">
								...
								<div class="card card-flush mb-5 mt-5" style="min-height: 18em; display: flex; justify-content: center; margin-bottom: 1em;">
	                                    ...
	                                    <c:if test="${parentCloud.cloudKnd ne 'prvt' }">
	                                    <!-- 직급 출력 시작 -->
						                                 ...
						                                 <tr>
						                                    ...
						                                    <td width="43%" id="cloudNameTd">
						                                        <div class="d-flex align-items-center">
						                                            ...
						                                            <a href="/company/cloudList.do?selectStrgCd=${cloudStrgFldr.cloudStrgFldrCd }" class="text-gray-800 text-hover-primary" onclick="f_fldrLinkBtn('${cloudStrgFldr.cloudStrgFldrCd }', event)">${cloudStrgFldr.cloudStrgFldrNm }</a> 
						                                        </div>  
						                                    </td>
						                                    <td width="10%" class="text-center">-</td>
						                                    <td width="10%" class="text-center">-</td> 
						                                       ...
						                                       <div class="d-flex align-items-center">
						                                           <a href="/company/imgPreview.do?cloudFileCd=${cloudStrgFile.cloudFileCd }" target="_blank" class="">
					                                       			...
					                                       			<c:if test="${cloudStrgFile.cloudFileExtnNm eq 'jpg' ||
																		...
																		<a href="/company/imgPreview.do?cloudFileCd=${cloudStrgFile.cloudFileCd }" target="_blank" class="ki-duotone ki-magnifier ms-2 imgPreview fs-5"> 
																			<span class="path1"></span>
																			<span class="path2"></span>
																		</a>
																	</c:if>
...
function f_openMoveListModal() {
    const modalMove = document.getElementById('modalMoveList');
    const modal = new bootstrap.Modal(modalMove);
    modal.show();
}
...
function f_cloudNewFlrdJobgradeCall(cloudKnd) {
	...
	if (cloudKnd != 'prvt') {
		...
		axios.get("/company/jobgradeSelectList.do")
		.then(function (res) {
			console.log(res);
...
function f_newFolderAddBtn() {
	...
	// 폴더명 중복 체크
	axios.get("/company/newCloudFldrNameCheck.do?cloudFldrName=" + newFldrName)
	.then(function (res) {
		console.log(res);
