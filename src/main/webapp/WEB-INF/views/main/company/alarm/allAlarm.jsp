...
<% 
   ...
   categoryMap.put("elapr", "전자결재"); 
   categoryMap.put("cmntyRe", "커뮤니티"); 
   categoryMap.put("community", "커뮤니티"); 
   categoryMap.put("calender", "일정"); 
   categoryMap.put("project", "프로젝트"); 
   categoryMap.put("video", "화상채팅"); 
   categoryMap.put("car", "차량 예약"); 
   categoryMap.put("facilty", "시설 예약"); 
   categoryMap.put("vacation", "휴가"); 
   categoryMap.put("prove", "증명서"); 
   categoryMap.put("info", "인사 • 정보 관리"); 
...
<script type="text/javascript">
	$(function() {
		...
		$(".delAlarm").on("click", function(e) {
			...
			const alarmNo = $(this).closest('tr').find(".alarmNo").val();
			console.log("hi");
