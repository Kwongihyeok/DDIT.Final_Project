...
<div id="kt_app_content_container" class="app-container container-fluid" style="height: 100%;">
	<div style="height: 100%;">
		...
		<form action="/company/cmntyQstnList.do" id="searchForm" style="display: contents;"> 
			<input type="hidden" name="cmntyType" id="cmntyType"> 
		</form>
	
		<form action="/company/cmntyQstnDelete.do" id="delForm" style="display: contents;" me> 
				...
				<c:choose>
							...
							<c:when test="${cmntyVO.qstnEmpId eq emp.empId }">
							    ...
							    <div class="card-footer py-0"> 
							        <div class="d-flex justify-content-end">  
						                <div class="my-3">
						                    <button id="modifyBtn" class="btn btn-sm btn-info" onclick="location.href='/company/cmntyQstnModify.do?cmntyNo=${cmntyVO.cmntyNo }'">수정</button>
						                    <button id="delBtn" class="btn btn-sm btn-danger">삭제</button> 
						                    <button id="listBtn" class="btn btn-sm btn-primary" onclick="location.href='/company/cmntyQstnList.do'">목록</button> 
						                </div>
							        </div> 
								</div>
							</c:when>
					...
					<c:otherwise>
						...
						<div id="cardFooter" class="card-footer py-2">
							...
							<div>
								<button id="listBtn" class="btn btn-sm btn-primary mb-2 float-end" onclick="location.href='/company/cmntyQstnList.do'">목록</button> 
							</div>
					    </div>
					</c:otherwise>
				</c:choose>
