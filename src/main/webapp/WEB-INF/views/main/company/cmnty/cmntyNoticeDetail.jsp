	...
	<div class="row" style="height: 100%;">
		<div class="col-12 pe-2" id="kt_app_root"> 
			<div class="card pe-0 mb-5">
					...
					<form id="noticeForm" action="/company/cmntyNoticeDelete.do" method="post">
						<input type="hidden" name="cmntyNo" value="${cmntyVO.cmntyNo }">
					</form>
					<form id="noticeDelForm" action="/company/cmntyNoticeDelete.do" method="post">
						<input type="hidden" name="cmntyNo" value="${cmntyVO.cmntyNo }">
							...
							<div class="mt-7 mb-2 w-100" style="display: flex;">
								<div class="fw-semibold fs-2x" style="width: 100%">
									<c:if test="${cmntyVO.cmntyNoticeYn eq 'Y' }">
										<font style="color: red">[필수공지] </font>
									</c:if>
																...
																<div class="dropzone-item p-2 py-1 dz-image-preview mt-1">
																	<div class="dropzone-file"> 
																		...
																		<c:if test="${atchFileDetailVO.atchFileDetailExtnNm eq 'jpg' ||
																			...
																			<a href="/company/cmnty/imgPreview.do?atchFileDetailCd=${atchFileDetailVO.atchFileDetailCd }" target="_blank" class="ki-duotone ki-magnifier ms-2 imgPreview fs-5"> 
																				<span class="path1"></span>
																				<span class="path2"></span>
																			</a>
																		</c:if>
																	</div>   
																	<a href="/company/cmntyDownOne.do?atchFileDetailCd=${atchFileDetailVO.atchFileDetailCd }">
...
$(function() {
   ...
   modifyBtn.on('click', function() {
      location.href= "/company/cmntyNoticeModify.do?cmntyNo=" + cmntyNo; 
   });
   ...
   listBtn.on('click', function() {
	    location.href= "/company/cmntyNoticeList.do";
   });
   ...
   fileAllDowmload.on('click', function() { 
        ...
        axios.post("/company/cmntyDownList.do", {
...
function f_fileDownOne(fileDetailCd) {
	...
	axios.post("/company/cmntyDownOne.do", {
