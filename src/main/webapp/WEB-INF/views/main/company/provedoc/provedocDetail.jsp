                                      ...
                                      <div class="card-title" style="width: 100%;">
                                         <div style="width: 100%; display: flex; justify-content: space-between;">
                                            <div style="display: flex; align-items: center;">
                                                <h2><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">증명서 수정 및 발급</font></font></h2>
                                            </div>
                                         </div>
                                      </div>
                                  </div>
                                  ...
                                  <div class="card-body pt-0" style="margin-top: 20px;">
                                      <div class="mb-10 fv-row fv-plugins-icon-container">
                                         ...
                                         <form action="/company/comProvedocIsprUpdate.do" method="post">
	                                         ...
	                                         <!--CKEditor 시작-->
	                                         <c:choose>
	                                         	<c:when test="${authrityNm eq 'ROLE_COMPANY'}">
			                                         <c:choose>
...
$(function() {
    ...
    const editor = CKEDITOR.instances.formEditorCK;

    // 에디터가 준비된 후 (인) 위치에 이미지 삽입
    editor.on('instanceReady', function() {
        // (인) 텍스트를 찾기
        const content = editor.getData();
        const updatedContent = content.replace('(인)', '<span style="position: relative;">(인)<img src="' + contextPath + '/resources/file/image/groubear_sign.png" style="position: absolute; max-width: 180%; top: -35px; left: -10px;"></span>');
