						...
						<div class="card-body pt-0 pb-0">
							...
							<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
								<li class="nav-item mt-2">
									<a href="/company/comElaprRernc.do" class="nav-link text-active-primary ms-0 me-10 py-5" >
										참조 문서함
									</a>
								</li>
								<li class="nav-item mt-2">
									<a href="/company/comElaprPrsl.do" class="nav-link text-active-primary ms-0 me-10 py-5  active">
										열람 문서함
									</a>
								</li>
							</ul>
						...
						<div class="table-responsive">
							...
							<table class="table align-middle table-row-bordered table-hover table-row-solid gy-4 gs-9">
								...
								<tbody class="fw-6 fw-semibold text-gray-600">
									<c:set value="${pagingVO.dataList }" var="prslList"/>
									<c:choose>
										<c:when test="${empty prslList }">
											<tr>
												<td colspan="9" class="text-center pt-5">
													<img src="/resources/file/image/cloudEmpty.png" class="w-50"/>
													<h3 class=" fw-bolder text-dark">열람 문서가 존재하지 않습니다.</h3>
												</td>
											</tr>
										</c:when>
										<c:otherwise>
											<c:forEach items="${prslList }" var="elaprVO">
												<tr>
