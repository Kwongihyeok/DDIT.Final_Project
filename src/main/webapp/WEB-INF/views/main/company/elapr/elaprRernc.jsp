					...
					<div class="card-body pt-0 pb-0">
						...
						<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
							<li class="nav-item mt-2">
								<a href="/company/comElaprRernc.do" class="nav-link text-active-primary ms-0 me-10 py-5 active" >
									참조 문서함
								</a>
							</li>
							<li class="nav-item mt-2">
								<a href="/company/comElaprPrsl.do" class="nav-link text-active-primary ms-0 me-10 py-5">
									열람 문서함
								</a>
							</li>
						</ul>
