...
<script src="${pageContext.request.contextPath }/resources/design/js/custom/apps/calendar/empCalendar.js"></script>
				 ...
				 <div class="card card-flush mb-2" style="height: 70px;">
				 	<div class="card-body d-flex" style="padding: 1em; align-items: center;">
				 		<div class="menu-item" data-category="all">
				 			<div class="menu-link py-3 divHover clickBackColor position-relative ms-5">
						...
						<div class="menu-item" data-category="calendar-event">
							<div class="menu-link py-3 divHover clickBackColor position-relative ms-5">
								<span class="menu-icon">
						...
						<div class="menu-item" data-category="project-event">
							<div class="menu-link py-3 divHover clickBackColor position-relative ms-5">
								<span class="menu-icon">
						...
						<div class="menu-item" data-category="elapr-event">
							<div class="menu-link py-3 divHover clickBackColor position-relative ms-5">
								<span class="menu-icon">
