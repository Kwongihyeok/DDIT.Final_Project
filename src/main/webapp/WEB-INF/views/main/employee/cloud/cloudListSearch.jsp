				        						   ...
				        						   <c:set var="cloudFileList" value="${CloudStrgVO.cloudFileList}" />	
			                           				  ...
			                           				  <c:forEach items="${cloudFileList }" var="cloudFile">
							                               ...
							                               <tr>
							                                   ...
							                                   <td width="43%">
							                                       <div class="d-flex align-items-center">
							                                           <a href="/employee/imgPreview.do?cloudFileCd=${cloudFile.cloudFileCd }" target="_blank" class="">
						                                       			...
						                                       			<c:if test="${cloudFile.cloudFileExtnNm eq 'jpg' ||
																			...
																			<a href="/employee/imgPreview.do?cloudFileCd=${cloudFile.cloudFileCd }" target="_blank" class="ki-duotone ki-magnifier ms-2 imgPreview fs-5"> 
																				<span class="path1"></span>
																				<span class="path2"></span>
																			</a> 
																		</c:if> 
