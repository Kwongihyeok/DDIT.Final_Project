...
<form action="/empinformation/empdelete.do" method="post" id="delForm">
...
//     const delSubmit = $("#delSubmit");
    ...
    modifyBtn.on("click", function(){
        ...
        $.ajax({
            url: "/empinformation/empinfomodify.do", // 서버 URL
            type: "POST",
    ...
    listBtn.on('click', function(event) {
        event.preventDefault(); // 기본 링크 클릭 동작 방지
        location.href = "/empinformation/allinfo.do"; // URL을 직접 할당
    });
