...
<form id="projectTaskForm" action="/employee/canbanInsert.do" method="post">
...
$(function () {
	...
	cancelBtn.on('click', function() {
		Swal.fire({
			...
			if (result.isConfirmed) {
				location.href = "/employee/canbanList.do?proNo=${projectTaskVO.proNo}";
			}
		})
	});
	...
	$(document).ready(function () {
	    ...
	    addTasKBtn.on("click", function () {
	        ...
	        if ($(this).val() == "수정") {
	            projectTaskForm.attr("action", "/employee/canbanUpdate.do");
	        }
