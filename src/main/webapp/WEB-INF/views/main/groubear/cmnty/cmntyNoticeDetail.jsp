	...
	<div class="row" style="height: 100%;">
		<div class="col-12 pe-2" id="kt_app_root"> 
			<div class="card pe-0 mb-5">
					...
					<form id="noticeForm" action="/groubear/cmntyNoticeDelete.do" method="post">
						<input type="hidden" name="cmntyNo" value="${cmntyVO.cmntyNo }">
					</form>
					<form id="noticeDelForm" action="/groubear/cmntyNoticeDelete.do" method="post">
						<input type="hidden" name="cmntyNo" value="${cmntyVO.cmntyNo }">
					...
					<div>
						...
						<div class="card-header"> 
							...
							<div class="my-4 w-100" class="mt-3 mb-5" style="display: flex;">  
								...
								<div class="d-flex justify-center fw-semibold text-gray-800" style="width: 15%;">
									<c:out value="${fn:substring(cmntyVO.cmntyRegDt, 0, 16)}" /> 
							    </div>
								<div style="width: 3%;">   
																...
																<div class="dropzone-item p-2 py-1 dz-image-preview mt-1">
																	<div class="dropzone-file"> 
																		...
																		<c:if test="${atchFileDetailVO.atchFileDetailExtnNm eq 'jpg' ||
																			...
																			<a href="/groubear/imgPreview.do?atchFileDetailCd=${atchFileDetailVO.atchFileDetailCd }" target="_blank" class="ki-duotone ki-magnifier ms-2 imgPreview fs-5"> 
																				<span class="path1"></span>
																				<span class="path2"></span>
																			</a>
																		</c:if>
																	</div>   
																	<a href="/groubear/cmntyDownOne.do?atchFileDetailCd=${atchFileDetailVO.atchFileDetailCd }">
						...
						<div class="card-footer p-0 py-5">
							<div class="d-flex justify-content-end pe-5"> 
								<div> 
									<input type="button" id="modifyBtn" class="btn btn-light-primary" value="수정">
								</div>
...
$(function() {
   ...
   modifyBtn.on('click', function() {
      location.href= "/groubear/cmntyNoticeModify.do?cmntyNo=" + cmntyNo; 
   });
   ...
   fileAllDowmload.on('click', function() { 
        ...
        axios.post("/groubear/cmntyDownList.do", {
...
function f_fileDownOne(fileDetailCd) {
	...
	axios.post("/groubear/cmntyDownOne.do", {
