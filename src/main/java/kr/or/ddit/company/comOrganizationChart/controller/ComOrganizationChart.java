package kr.or.ddit.company.comOrganizationChart.controller;
...
public class ComOrganizationChart {
	...
	@GetMapping("/comorganizationchart.do")
	public String comOrganizationChart(Model model) {
		...
		List<EmployeeVO> orgEmpList = infoService.orgEmpList(employeeVO);
		...
		return "company/organizationChart/organizationChartForm";
	}
