package kr.or.ddit.comm.cmnty.mapper;
...
public interface ICmntyMapper {
	 ...
	 * @return
	 */
	public int cmntyQstnInsert(CmntyVO cmntyVO);
	 ...
	 * @return
	 */
	public int cmntyQstnModify(CmntyVO cmntyVO);
	 ...
	 * @return
	 */
	public int cmntyQstnDelete(int cmntyNo);
}
